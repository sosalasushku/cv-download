const onListItemChange = onChangeItterableElement(
  "li",
  "Type something",
  true,
  null,
);
const onChangeInterestsList = onChangeItterableElement(
  "div",
  "Add interest",
  true,
  "more-section_interests_body_item",
);
const onChangeHashtagsList = onChangeItterableElement(
  "div",
  "Add hashtag",
  true,
...
function onChangeItterableElement(
  elementType,
  ...
  const customFunction = function (e, el, parentElement) {
    ...
    if (e.keyCode === 13) {
      ...
      if (el.innerText !== "") {
        ...
        newElement.onkeydown = (e) =>
          customFunction(e, newElement, parentElement);
      ...
      e.keyCode === 8 &&
      ((enableEmptyValue && el.innerText === "") ||
        (!enableEmptyValue && el.innerText.length === 1))
    ) {
      e.preventDefault();
...
document.addEventListener("readystatechange", () => {
  ...
  const allLevels = document.getElementsByClassName(
